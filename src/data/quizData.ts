...
export const femaleQuizQuestions: QuizQuestion[] = [
  // D vs S (도파민/세로토닌) - 7 questions
  {
    ...
    question: "업무 중 짜증이 치솟아 집중이 안 된다.\n이 파괴적인 에너지를 어떻게 다룰 것인가?",
    options: [
  ...
  },
  {
    ...
    question: "연인에게 연락두절.\n평소라면 넘어갈 일에 불안감과 짜증이 동시에 밀려올 때의 행동은?",
    options: [
  ...
  },
  {
    ...
    question: "연인이 포옹을 시도하자, '좋지만 짜증 나는' 감정이 평소와 달리 동시에 든다.\n원하는 해결책은?",
    options: [
  ...
  },
  {
    ...
    question: "평소와 달리 '나 왜 이렇게 일 못하지?'\n자책이 들 때, 가장 빨리 회복하는 방법은?",
    options: [
  ...
  // T vs E (테스토스테론/에스트로겐) - 3 questions
  {
    ...
    question: "연인에게 서운함 폭발.\n연인이 \"구체적으로 뭘 잘못했는지 말해줘\"라고 물을 때, 당신의 우선순위는?",
    options: [
  ...
  },
  {
    id: 9,
    situation: "📝 [직장] 피드백 수용",
    question: "상사에게 업무 보고서의 '논리 부족'에 대해 지적받았다.\n평소보다 감정적 타격이 클 때, \n당신의 반응은?",
    options: [
...
export const femaleTypes: Record<string, HormoneType> = {
  T_D: {
    ...
    villainTrait: '"결론이 뭔데?"\n서론이 길면 영혼까지 탈곡해버리는 인간 작두입니다.\n상대방이 눈치 없이 웅얼거리면 차가운 눈빛으로 말을 자르고 "모르면 나가"라는 오라를 풍기며, 내 페이스에 못 따라오는 모든 생명체를 무능한 죄인으로 취급하는 폭군 모드에 진입합니다.',
    heroTrait: '혼돈의 전장을 정리하고 승리로 이끄는 압도적인 지략가이자 천부적인 리더입니다.\n남들이 감정에 휘둘려 주저할 때, 당신의 명쾌한 판단력과 추진력은 정체된 세상을 움직이는 유일한 동력이 됩니다.',
    careTip: 'T와 코르티솔이 동시 폭주하여 뇌가 \'전시 상황\'입니다.\n마그네슘과 테아닌으로 교감신경을 안정시키고, 뇌에 강제 휴전 협정을 선언할 쿨다운 시간을 반드시 가지세요.',
    partnerTip: '즉시 무릎을 꿇고 결론부터 3초 안에 보고하십시오.\n변명은 사형입니다.',
    ...
    survivalTip: 'T와 코르티솔이 동시 폭주하여 뇌가 \'전시 상황\'입니다.\n마그네슘과 테아닌으로 교감신경을 안정시키고 쿨다운 시간을 가지세요.',
    bfGuide: '즉시 무릎을 꿇고 결론부터 3초 안에 보고하십시오.\n변명은 사형입니다.',
  },
  S_T: {
    code: 'S_T',
    title: '은둔귀족',
    ...
    villainTrait: '"내 영역에서 꺼져."\n가시덤불을 치고 스스로를 유폐시키는 어둠의 지배자입니다.\n호르몬이 바닥나면 모든 인간의 목소리가 소음으로 들려 "말 걸면 저주한다"는 눈빛으로 상대를 얼려버리며, 다정한 걱정조차 침범으로 간주해 차갑게 쳐내는 냉혈한이 됩니다.',
    heroTrait: '세상의 소음을 차단하고 본질을 꿰뚫어 보는 고고한 통찰력을 가졌습니다.\n당신의 침묵은 무관심이 아니라 가장 완벽한 답을 찾기 위해 자기 내면의 심연으로 파고드는 숭고한 숙고의 시간입니다.',
    careTip: '에스트로겐 하락으로 통증 역치가 낮아져 모든 자극이 쓰라리게 느껴지는 상태입니다.\n비타민 D와 오메가3로 신경계를 보호하고, \'안전한 어둠\' 속에서 에너지를 보존하세요.',
    partnerTip: '동굴 입구 근처에도 가지 마십시오.\n"무슨 일 있어?"는 자폭 버튼입니다.\n조용히 문틈으로 간식만 밀어 넣고 철수하는 것이 최고의 사랑입니다.',
    ...
    bfGuide: '동굴 입구 근처에도 가지 마십시오.\n조용히 문틈으로 간식만 밀어 넣고 철수하세요.',
  },
  D_T: {
    code: 'D_T',
    title: '오뜨꾸뛰르',
    ...
    villainTrait: '"내 세상에 오점은 허용 안 해."\n질서가 깨지는 꼴을 못 보는 피곤한 완벽주의자입니다.\n방바닥의 머리카락 한 올, 약속 시간 1분의 오차에 발광하며 주변 사람들을 쥐 잡듯 잡아 상대의 기를 완전히 죽여놓는 히스테릭 여왕입니다.',
    heroTrait: '어떤 풍파가 와도 삶의 기강을 잡는 위대한 설계자입니다.\n당신의 꼼꼼함과 책임감은 불확실한 미래를 대비하는 가장 강력한 방패이며, 주변 사람들은 당신 덕분에 안전함과 질서를 누리게 됩니다.',
    careTip: 'FSH와 LH의 불균형으로 뇌가 극도의 긴장 상태입니다.\n이노시톨로 호르몬 조절을 돕고, \'완벽\'보다 \'무사\'에 집중하여 뇌의 피로도를 낮추는 연습이 필요합니다.',
    partnerTip: '변명 대신 "시정하겠습니다!"라고 각 잡고 외치며 군대식 의전을 수행하십시오.\n그녀의 권위를 인정하고 비위를 맞추는 것만이 가정이 평화로워지는 지름길입니다.',
    bestMatch: '원칙주의 현장감독, 베테랑 조명감독',
    worstMatch: '자유영혼 스턴트팀, 슈퍼긍정 제작진',
    diagnosis: '"내 세상에 오점은 허용 안 해."\n질서가 깨지는 꼴을 못 보는 완벽주의자입니다.',
  ...
  T_S: {
    ...
    villainTrait: '"So?"\n한마디로 파트너의 영혼을 가출하게 만드는 정서적 냉동고입니다.\n애착 호르몬이 증발하면 다정함이 징그럽게 느껴져, 남친의 꽃 선물에도 "식물이 죽어가는 걸 왜 보라는 거야?"라며 찬물을 끼얹는 냉소주의자입니다.',
    heroTrait: '타인의 시선이나 가면을 거부하고 오직 나만의 진실을 쫓는 독보적인 독립 영혼입니다.\n당신의 차가운 지성은 거짓과 가식을 걸러내는 거름망이 되며, 삭막한 세상에서 가장 순수한 이정표가 됩니다.',
    careTip: '옥시토신 분비가 일시 중단되어 타인과의 연결을 \'스트레스\'로 인식합니다.\n억지로 다정해지려 애쓰지 마세요.\n혼자만의 시간을 통해 뇌의 과열을 식히는 것이 최우선입니다.',
    partnerTip: '재롱떨지 마십시오.\n투명인간 취급하고 당신도 당신만의 독고다이 길을 가십시오.\n아이러니하게도 당신이 무관심할수록 그녀는 당신을 흥미로운 관찰 대상으로 인식할 것입니다.',
    bestMatch: '자유영혼 스턴트팀, 무덤덤 보안팀',
    worstMatch: '슈퍼긍정 제작진, 눈물공감 소품팀',
    diagnosis: '"So?"\n한마디로 파트너의 영혼을 가출하게 만드는 정서적 냉동고입니다.',
    normalSelf: '타인의 시선이나 가면을 거부하고 오직 나만의 진실을 쫓는 독보적인 독립 영혼입니다.',
    survivalTip: '억지로 다정해지려 애쓰지 마세요.\n혼자만의 시간을 통해 뇌의 과열을 식히세요.',
    bfGuide: '재롱떨지 마십시오.\n투명인간 취급하고 독고다이 길을 가세요.',
  },
  S_E: {
    code: 'S_E',
    title: '아티스트',
    ...
    color: 'from-hot-pink to-rose',
    villainTrait: '"나 사랑해? 안 버릴 거지?"라며 끊임없이 관계에 수류탄을 던지는 자폭형 빌런입니다.\n아주 작은 말투 변화도 이별의 징조로 해석해 급발진하고, 울고불고 매달리다 다 때려 부수는 감정 테러리스트입니다.',
    heroTrait: '나노 단위의 감정 흐름을 캐치해 타인의 영혼을 위로하는 공감 요정입니다.\n당신의 예민함은 세상을 수만 가지 색으로 느끼는 남다른 감수성의 다른 이름이며 일상을 영화 같은 감동으로 바꿉니다.',
    careTip: '프로게스테론의 급격한 변동으로 뇌의 불안 스위치가 고장 났습니다.\n세로토닌 합성을 돕는 영양소와 충분한 당 섭취로 뇌의 재난 경보를 꺼주어야 합니다.',
    partnerTip: '논리적으로 따지지 마십시오.\n모든 지능을 \'찬양\'에 쏟아부으십시오.\n그녀가 세상을 부수고 있어도 "자기는 부술 때도 예술이야!"라고 외치는 앵무새가 되어야 합니다.',
    bestMatch: '슈퍼긍정 제작진, 눈물공감 소품팀',
    worstMatch: '원칙주의 현장감독, 베테랑 조명감독',
    diagnosis: '"나 사랑해? 안 버릴 거지?"\n끊임없이 관계에 수류탄을 던지는 자폭형 빌런입니다.',
    normalSelf: '나노 단위의 감정 흐름을 캐치해 타인의 영혼을 위로하는 공감 요정입니다.',
    survivalTip: '세로토닌 합성을 돕는 영양소와 충분한 당 섭취로 뇌의 재난 경보를 꺼주세요.',
    bfGuide: '논리적으로 따지지 마세요.\n"자기는 부술 때도 예술이야!"라고 외치세요.',
  },
  E_D: {
    code: 'E_D',
    title: '힐링디바',
    ...
    villainTrait: '"물 떠와라, 밥 차려라."\n중력이 10배가 된 듯 침대와 한 몸이 되어 남친을 머슴처럼 부려먹는 나태 빌런입니다.\n손가락 하나 까딱 안 하면서 잔소리를 퍼붓고, 안 들어주면 "사랑이 식었네"라며 가스라이팅을 시전합니다.',
    heroTrait: '존재만으로 사람들을 무장 해제시키는 풍요로운 대지의 여신입니다.\n당신의 여유로운 템포는 바쁘게 뛰어가느라 소중한 것을 놓치는 사람들에게 \'진정한 쉼\'이 무엇인지 일깨워주는 안식처가 됩니다.',
    careTip: '프로게스테론이 정점을 찍으며 몸에 수분을 가두고 대사를 늦추고 있습니다.\n억지로 움직이려 하지 말고 림프 순환을 돕는 가벼운 스트레칭과 죄책감 없는 휴식에만 집중하세요.',
    partnerTip: '"운동해" 소리는 죽고 싶을 때나 하십시오.\n그녀의 다리가 되어 맛집 메뉴를 대령하고 발바닥을 주무르는 충실한 하인이 되면 그녀는 세상에서 가장 다정한 마님이 되어줄 것입니다.',
    bestMatch: '섬세살뜰 케이터링팀, 무덤덤 보안팀',
    worstMatch: '원칙주의 현장감독, 메인로드 매니저',
    diagnosis: '"물 떠와라, 밥 차려라."\n침대와 한 몸이 되어 남친을 머슴처럼 부려먹는 나태 빌런입니다.',
    normalSelf: '존재만으로 사람들을 무장 해제시키는 풍요로운 대지의 여신입니다.',
    survivalTip: '림프 순환을 돕는 가벼운 스트레칭과 죄책감 없는 휴식에만 집중하세요.',
    bfGuide: '"운동해" 소리는 금지.\n맛집 메뉴를 대령하고 발바닥을 주물러 주세요.',
  },
  D_E: {
    code: 'D_E',
    title: '메소드배우',
    ...
    villainTrait: '웃다가 1초 만에 통곡하고 화내다 갑자기 키스하는 예측 불가 빌런입니다.\n종잡을 수 없는 텐션으로 파트너의 멘탈을 롤러코스터에 태우며 지루함을 참지 못해 멀쩡한 현장을 난장판으로 만듭니다.',
    heroTrait: '지루한 세상에 다채로운 색깔을 입히고 활력을 불어넣는 독보적인 에너지 뱅크입니다.\n당신의 투명하고 솔직한 감정 표현은 가식적인 관계에 환멸을 느낀 사람들에게 신선한 카타르시스를 줍니다.',
    careTip: '에스트로겐과 도파민이 널뛰기 중입니다.\n감정의 파도를 막으려 하지 말고 흐름을 인정하되, 뇌 소모를 막아줄 비타민 B군을 보충하세요.\n변덕은 뇌가 재미를 찾는 전략입니다.',
    partnerTip: '당황하지 마십시오.\n그녀의 롤러코스터에 안전바 꽉 잡고 같이 소리 지르며 즐기십시오.\n그녀가 미친 짓을 하면 "역시 내 여주인공!"이라며 엄지를 치켜세우는 똘끼가 필요합니다.',
    ...
    survivalTip: '뇌 소모를 막아줄 비타민 B군을 보충하세요.\n변덕은 뇌가 재미를 찾는 전략입니다.',
