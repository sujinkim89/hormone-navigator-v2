...
export const femaleQuizQuestions: QuizQuestion[] = [
  // [STAGE 1] 광기 어린 폭주(D) vs 서늘한 단절(S) - 5 questions
  {
    ...
    question: "오늘따라 뭘 입어도 이상해 보인다. 거울 속 내 모습이 마음에 안 들 때 행동은?",
    options: [
      { text: "파괴적 변신: 과감한 착장으로 변신", type: 'D' },
      { text: "사회적 단절: 변명으로 약속 취소", type: 'S' },
    ],
    axis: 'DS',
  },
  {
    ...
    question: "상사가 내 업무를 콕 집어 지적했다. 자존감이 바닥을 칠 때 나의 반응은?",
    options: [
      { text: "도파민 도박: 신규 프로젝트로 일 벌리기", type: 'D' },
      { text: "투명인간 모드: 알림 끄고 투명인간 모드", type: 'S' },
    ],
    axis: 'DS',
  },
  {
    ...
    question: "연인이 24시간째 읽씹 중이다. 평소라면 넘어갈 일에 불안과 짜증이 밀려올 때?",
    options: [
      { text: "수사대 가동: 카톡과 SNS 감시로 찾아내기", type: 'D' },
      { text: "이별 준비: 앨범 속 사진 하나씩 삭제하기", type: 'S' },
    ],
    axis: 'DS',
  },
  {
    ...
    question: "아무 이유 없이 모든 게 다 거슬린다. 이 짜증을 어떻게 해소할 것인가?",
    options: [
      { text: "탕진 쾌락: 충동적 결제로 아이템 업그레이드", type: 'D' },
      { text: "벙커 고립: 현관문 잠그고 이불 속 잠입", type: 'S' },
    ],
    axis: 'DS',
  },
  {
    ...
    question: "몸이 납덩이처럼 무겁다. 침대에서 일어나기 싫은 아침, 나의 선택은?",
    options: [
      { text: "고문 부팅: 샷 추가 후 헬스장 직행", type: 'D' },
      { text: "존재 말소: \"오늘의 나는 없다\" 병가 요구", type: 'S' },
    ],
    axis: 'DS',
  },
  // [STAGE 2] 지배적 통제(T) vs 뜨거운 연결(E) - 5 questions
  {
    ...
    question: "자괴감이 뇌를 점령했다. 이 상황에서 마음을 다잡는 방법은?",
    options: [
      { text: "야망 박제: 성과를 SNS에 올리며 안도", type: 'T' },
      { text: "공감 구걸: 단톡방에 불행 전시 후 공감 받기", type: 'E' },
    ],
    axis: 'TE',
  },
  {
    ...
    question: "뉴스에 난소 건강 기사가 떴다. 평소보다 불안감이 크게 엄습할 때 나의 반응은?",
    options: [
      { text: "완벽 지배: 즉시 검진 예약 후 계획 수립", type: 'T' },
      { text: "불안 공유: 연인 붙잡고 친구들과 공감대 형성", type: 'E' },
    ],
    axis: 'TE',
  },
  {
    ...
    question: "연인이 \"뭘 잘못했는지 말해줘\"라고 물을 때 당신의 우선순위는?",
    options: [
      { text: "법령 제정: 서운함 정리 후 재발 방지 규칙 공표", type: 'T' },
      { text: "감정 포위: \"내 마음 몰라?\" 공감 올 때까지 대화 거부", type: 'E' },
    ],
    axis: 'TE',
  },
  {
    ...
    question: "상사에게 혹평을 들었다. 감정적 타격이 클 때 머릿속에 떠오르는 시나리오는?",
    options: [
      { text: "복수 시나리오: \"훗. 니가 감히?\" 복수 시나리오 작성", type: 'T' },
      { text: "비련 시나리오: \"나 미워하나봐ㅠㅠ\" 왕따 시나리오 작성", type: 'E' },
    ],
    axis: 'TE',
  },
  {
    ...
    question: "'내가 왜 이러지...' 이유 없이 눈물이 날 때, 스스로를 바라보는 시각은?",
    options: [
      { text: "화학적 오류: \"호르몬 오류다\" 논문 검색", type: 'T' },
      { text: "존재적 침잠: \"무너지는 것도 나야\" 스스로 다독이기", type: 'E' },
    ],
    axis: 'TE',
  },
];
...
export const maleQuizQuestions: QuizQuestion[] = [
  // [STAGE 1] Serotonin(S) vs Dopamine(D)
  {
    ...
    question: "외출 전, 그녀가 거울 속 자기 모습이 싫다며 약속을 취소하자 할 때 나의 반응은?",
    options: [
  ...
  },
  {
    ...
    question: "오늘따라 그녀도 예민하고 나도 힘들다. 세상 모든 게 짜증 날 때, 나의 선택은?",
    options: [
  ...
  },
  {
    ...
    question: "그녀가 24시간째 연락이 없다. 이때 나의 행동은?",
    options: [
  ...
  },
  {
    ...
    question: "그녀가 이유 없이 날카로운 독설로 공격한다. 나의 반응은?",
    options: [
  ...
  },
  {
    ...
    question: "그녀가 무기력하게 침대에서 꼼짝 않는다. 나의 대처는?",
    options: [
  ...
  // [STAGE 2] Testosterone(T) vs Estrogen(E)
  {
    ...
    question: "그녀가 \"나 왜 이렇게 바보 같지?\"라며 운다. 나의 위로는?",
    options: [
  ...
  },
  {
    ...
    question: "그녀가 불안한 건강 기사를 보고 겁에 질렸다. 나의 행동은?",
    options: [
  ...
  },
  {
    ...
    question: "싸우던 중 \"내 마음이 어떤지 알아?\"라고 묻는다. 나의 대답은?",
    options: [
  ...
  },
  {
    ...
    question: "그녀가 \"요즘 나한테 영혼이 없어\"라고 서운해한다. 나의 반응은?",
    options: [
  ...
  },
  {
    ...
    question: "그녀의 이유 없는 오열이 터져 나왔다. 당신의 속마음은?",
    options: [
...
export const femaleTypes: Record<string, HormoneType> = {
  T_D: {
    ...
    villainTrait: '"말대꾸는 스매쉬로 답한다." 비효율적인 모든 것을 물리적으로 박살 내고 싶음. "결론이 뭐야!"라고 포효하며 주변을 쑥대밭으로 만듦.',
    heroTrait: 'PMS가 지나가면, 압도적인 파괴력을 수호 능력으로 바꿈. 혼돈을 전략으로 정리하고 승리로 이끄는 천부적 리더.',
    careTip: '전투 엔진을 식히기 위해 마그네슘이 시급합니다. \'강제 종료\' 휴식을 확보하세요.',
    partnerTip: '변명하는 건 자폭 버튼입니다. 3초 안에 결론만 보고하고 그냥 조용히 샌드백이 되어주세요.',
    bestMatch: '원칙주의 현장감독, 손발척척 로드매니저',
    worstMatch: '사슴눈망울 1호팬, 슈퍼긍정 조감독',
    refImage: '/type-refs/woman/초록빛 폭주 테토녀_쉬헐크.png',
    quote: '전 언제나 화가 나 있어요.\n그게 제 비밀이에요.',
  ...
  T_S: {
    ...
    villainTrait: '자신의 금기를 들키지 않으려 타인과 철저히 거리를 둠. "너는 감당할 수 없어"라며 상대를 서늘하게 밀어냄',
    heroTrait: '세상을 지키는 단단한 정의감. 내면의 고독을 묵묵히 견디며 결국 가장 소중한 것을 지켜내는 지킴이.',
    careTip: '고독하게 지친 마음을 L-테아닌으로 이완시키고, 완전한 암흑 속에서 휴식이 필요합니다.',
    partnerTip: '그녀가 필요할 땐 거리를 유지해주세요. 그녀의 어둠까지도 사랑하는 확신을 줄 때, 비로소 성문이 열립니다.',
    bestMatch: '승부사 스턴트팀, 철벽 경호팀',
    worstMatch: '슈퍼긍정 조감독, 사슴눈망울 1호팬',
    refImage: '/type-refs/woman/혼문 수호자 테토녀_루미.png',
    quote: '악령의 피가 흐르는 건 비밀이야.\n내 비밀을 캐내려고 하지마.',
  ...
  E_D: {
    ...
    quote: '빵이 없으면 케익을 주면 되잖아.\n나를 위해 가장 우아한 순간을 준비해줘.',
  ...
  D_E: {
    ...
    refImage: '/type-refs/woman/디바마을 퀸 에겐녀_할리퀸.png',
    quote: '조커야, 다 부숴볼까?\n재미없는 건 죽어도 싫거든!',
...
export const maleTypes: Record<string, HormoneType> = {
  D_T: {
    ...
    worstMatch: '디바마을 퀸 에겐녀, 혼문 수호자 테토녀',
    refImage: '/type-refs/man/원칙주의 현장감독_백종원.png',
    quote: '그게 맞쥬? 근데 왜 그렇게 했쥬?\n내가 알려준 대로만 해봐유.',
  ...
  S_T: {
    ...
    worstMatch: '혼문 수호자 테토녀, 디바마을 퀸 에겐녀',
  ...
  T_S: {
    ...
    bestMatch: '디바마을 퀸 에겐녀, 초록빛 폭주 테토녀',
    ...
    bfGuide: '뇌가 과부하 된 무뚝뚝한 방패입니다. "리액션 모드를 장착해달라"고 하면 기꺼이 든든한 샌드백이 됩니다.',
  },
  D_E: {
    code: 'D_E',
    title: '슈퍼긍정 조감독',
  ...
  E_S: {
    ...
    quote: '어머어머, 이상한 놈 다 잊고,\n내가 진짜 맛있는 프랑스 요리 해줄게!',
  ...
  S_E: {
    ...
    quote: '자기는 충분히 잘하고 있어요. 내가 다 봤는걸요.\n자기가 빛나는 순간을 놓치지 않을게요.',
